...
class AgreementTenderAdmin extends StatefulWidget {
  @override
  _AgreementTenderAdminState createState() => _AgreementTenderAdminState();
}

class _AgreementTenderAdminState extends State<AgreementTenderAdmin> {
  @override
                      ...
                      child: ListView(
                        children: [
                          _buildOptionCard(
                            ...
                            Icons.gavel,
                            Color(0xFF4A90E2),
                            () => _navigateToPage(context, '/agreement_auctions'),
                          ),
                          SizedBox(height: 20),
                          _buildOptionCard(
                            'Active Agreements',
                            ...
                            Icons.assignment,
                            Color(0xFF7ED321),
                            () => _navigateToPage(context, '/agreement_active_agreements'),
                          ),
                          SizedBox(height: 20),
                          _buildOptionCard(
                            'Supplier Feedback',
                            'Monitor supplier performance and feedback',
                            Icons.star_rate,
                            Color(0xFFF5A623),
                            () => _navigateToPage(context, '/agreement_supplier_feedback'),
                          ),
                          SizedBox(height: 20),
                          _buildOptionCard(
                            'Reports & Analytics',
                            'Handle analytics and reporting data',
                            Icons.analytics,
                            Color(0xFFBD10E0),
                            () => _navigateToPage(context, '/agreement_reports_analytics'),
                          ),
                        ],
                      ),
                    ),
